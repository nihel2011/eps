                                ...
                                <div class="collapse navbar-collapse" id="navbar-example">
                                    <div class="main-menu">
                                        <ul class="nav navbar-nav navbar-right">
											...
											<li><a class="pagess" href="#">Présentation</a>
												 
											</li>
											<li><a class="pagess" href="#">Services</a>
												 
											</li>
											<li><a class="pagess" href="#">Réferences</a>
											 
											</li>
											<li><a class="pagess" href="#">Actualités</a> 
											</li>
                        ...
                        <div class="col-md-12">
                                ...
                                <nav id="dropdown">
                                    <ul>
										...
										<li><a class="pagess" href="#">Références</a>
                        ...
                        <div class="contact-head">
                            ...
                            <div class="contact-icon">
								<div class="contact-inner">
									<h5>Location :</h5>
									<a href="#"><i class="fa fa-map"></i><span>Ettaoufik buildin Flour App 52 Sfax-tunisia</span></a>
									<a href="#"><i class="fa fa-phone"></i><span>+216 74 418 121</span></a>
									<a href="#"><i class="fa fa-envelope"></i><span>amessaoudi.eps@gmail.com</span></a>
								</div>
							</div>
                        </div>
                    </div>
