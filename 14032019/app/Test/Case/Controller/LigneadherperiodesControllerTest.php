<?php
App::uses('LigneadherperiodesController', 'Controller');

/**
 * LigneadherperiodesController Test Case
 */
class LigneadherperiodesControllerTest extends ControllerTestCase {
