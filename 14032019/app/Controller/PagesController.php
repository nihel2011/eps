...
/* public function change_long($lang=null)
 {
	 ...
	 echo 'ggg'.$this->Session->read('lang');
	                $this->Session->write('User.language',$this->Session->read('lang'));
	...
	// return $this->redirect($this->referer());
	 ...
	 public function accueil($menu_id=null)
 	{

		$this->loadModel('Contenus');
				 $this->Contenus->locale=Configure::read('Config.languages');

		$options = array('conditions' => array('Contenus.menu_id'=>1));
		$contenus=$this->Contenus->findAll('first',$options);
		$this->set('contenus',$contenus);
		$this->set('menu_id',$menu_id);
		/*	$this->loadModel('Category');
		$options = array('conditions' => array('Category.parent'=>0	));
