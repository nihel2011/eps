  ...
  <?php echo "\n".$this->Html->script('plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.min.js'); ?>
   ...
   <div class="container-fluid">
	...
	foreach(Configure::read('Config.languages') as $lang)
		...
		echo $this->Form->input('Partenaire.name.'.$lang,array('id'=>'name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		...
		?> 
		 <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/partenaires/'.$this->request->data['Partenaire']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
