...
<div class="col-sm-6">	<h3>Telecharchements</h3></div>	<div class=" col-sm-6 addplus"  >
		<a href="admin/Telecharchement/add">
...
<tbody>
	...
	<tr>
		...
		<td><?php echo h($telecharchement['Telecharchement']['name']); ?>&nbsp;</td>
		...
		<td class='hidden-480'>
			<?php echo "&nbsp;".$this->Html->link(__("<i class='fa fa-search'></i>"), array('action' => 'view', $telecharchement['Telecharchement']['id']),array('escape' => false,'class'=>'btn')); ?>
