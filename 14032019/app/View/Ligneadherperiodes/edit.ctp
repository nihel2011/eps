<div class="container-fluid">
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('adherents_id',array('id'=>'adherents_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='adherperiodes_id' class='control-label col-sm-2'>adherperiodes_id:</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('adherperiodes_id',array('id'=>'adherperiodes_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
