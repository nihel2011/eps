<div class="container-fluid">
		...
		echo $this->Form->input('adherents_id',array('id'=>'adherents_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off','empty'=>'-- Choisir Adherents --', 'options'=>$adherent) );
		echo "</div></div>"; 
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('adherperiodes_id',array('id'=>'adherperiodes_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off','empty'=>'-- Choisir Adherents periodes --', 'options'=>$adherperiode) );
		echo "</div></div>"; 
