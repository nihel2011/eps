...
<div class="container-fluid">
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>galeries</h3>
							</div>
							<div class="box-content nopadding">
                            <?php 
							 
							echo $this->Form->create('Galery',array('type'=>'file','role'=>'form','class'=>'form-horizontal form-column form-bordered')); ?>
                            		<div class="row">
										<div class="col-sm-12">
                            	<?php
	...
	foreach(Configure::read('Config.languages') as $lang)
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('Galery.name.'.$lang,array('id'=>'name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		 }
		echo "<div class='form-group'>"; 
		...
		<div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/galeries/'.$this->request->data['Galery']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
...
$type = array("P"=>"Photo","V"=>"Video");
		...
		echo "<div class='form-group'>"; 
		echo "<label for='catpho_name' class='control-label col-sm-2'>catpho_name:</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('catpho_name',array('id'=>'catpho_name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
