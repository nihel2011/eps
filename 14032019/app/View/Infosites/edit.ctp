<div class="container-fluid">
		...
		echo $this->Form->input('email',array('id'=>'email','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='fr_adresse' class='control-label col-sm-2'>fr_adresse:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('fr_adresse',array('id'=>'fr_adresse','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
		...
		echo $this->Form->input('fixe',array('id'=>'fixe','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='gsm' class='control-label col-sm-2'>gsm:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('gsm',array('id'=>'gsm','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
		...
		echo $this->Form->input('siteweb',array('id'=>'siteweb','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='fr_responsable' class='control-label col-sm-2'>fr_responsable:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('fr_responsable',array('id'=>'fr_responsable','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='ar_responsable' class='control-label col-sm-2'>ar_responsable:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('ar_responsable',array('id'=>'ar_responsable','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
		...
		echo $this->Form->input('fax',array('id'=>'fax','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='maps' class='control-label col-sm-2'>maps:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('maps',array('id'=>'maps','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
