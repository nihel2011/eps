<div class="container-fluid">
		...
		echo "<label for='login' class='control-label col-sm-2'>login:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('login',array('id'=>'login','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='mot_passe' class='control-label col-sm-2'>mot_passe:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('mot_passe',array('id'=>'mot_passe','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='mpas' class='control-label col-sm-2'>mpas:</label><div class='col-sm-10'>"; 
