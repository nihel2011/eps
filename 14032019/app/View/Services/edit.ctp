<div class="container-fluid">
		...
		echo "<div class='form-group'>"; 
		echo "<label for='id_contenu' class='control-label col-sm-2'>id_contenu:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('id_contenu',array('id'=>'id_contenu','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
		...
		echo "<div class='form-group'>"; 
		echo "<label for='resume' class='control-label col-sm-2'>resume:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('resume',array('id'=>'resume','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='description' class='control-label col-sm-2'>description:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('description',array('id'=>'description','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
