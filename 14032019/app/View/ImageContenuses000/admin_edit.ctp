<div class="container-fluid">
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>imageContenuses</h3>
							</div>
		...
		echo "<div class='form-group'>"; 
		echo "<label for='namep' class='control-label col-sm-2'>namep:</label><div class='col-sm-10'>"; 
		...
		echo "<div class='form-group'>"; 
		echo "<label for='contenu_id' class='control-label col-sm-2'>contenu_id:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('contenu_id',array('id'=>'contenu_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		...
		echo $this->Form->input('defau',array('id'=>'defau','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
