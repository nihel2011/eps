...
foreach(Configure::read('Config.languages') as $lang)
		...
		echo "<div class='form-group'>"; 
		echo "<label for='titre' class='control-label col-sm-2'>titre(".$lang."):</label><div class='col-sm-10'>"; 
		echo $this->Form->input('Activite.titre.'.$lang,array('id'=>'titre','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') ); 
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='description' class='control-label col-sm-2'>description(".$lang."):</label><div class='col-sm-10'>"; 
		echo $this->Form->input('Activite.description.'.$lang,array('type'=>'textarea','id'=>'description','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') ); 
		echo "</div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='resume' class='control-label col-sm-2'>resume(".$lang."):</label><div class='col-sm-10'>"; 
		echo $this->Form->input('Activite.resume.'.$lang,array('type'=>'textarea','id'=>'resume','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') ); 
		echo "</div>"; 
		 }
		...
		?>
		  <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/activite/'.$this->request->data['Activite']['image']." style='width:90%'>"; ?>
                                                </div>
												<div>
