<div class="container-fluid">
		...
		echo "<label for='titre' class='control-label col-sm-2'>titre:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('titre',array('id'=>'titre','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
