<div id="wrapper">
  ...
  <div id="preloader">
    <div id="spinner">
      <img src="<?php echo $this->webroot; ?>img/4.gif" alt="">
    </div>
          ...
          <div class="container pt-0 pb-0">
            <div class="row">
              <div class="col-md-8 col-md-offset-2">
                ...
                <a class="btn btn-border btn-gray btn-transparent btn-circled" href="<?php echo $this->webroot;?>">Return Home</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <footer id="footer" class="footer bg-black-333 text-center pt-20 pb-20">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <p class="text-black-777 m-0">Copyright &copy;2017 <a href="http://www.smdi.tn/">SMDI </a>All Rights Reserved</p>
        </div> 
      </div>
    </div>
  </footer>
