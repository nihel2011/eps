...
<tbody>
	...
	<tr>
		...
		<td><?php echo h($slideshow['Slideshow']['usercreated']); ?>&nbsp;</td>
		<td><?php echo h($slideshow['Slideshow']['modify']); ?>&nbsp;</td>
		<td><?php echo h($slideshow['Slideshow']['usermodify']); ?>&nbsp;</td>
		<td><?php echo h($slideshow['Slideshow']['photo']); ?>&nbsp;</td>
		...
		<td class='hidden-480'>
			<?php echo "&nbsp;".$this->Html->link(__("<i class='fa fa-search'></i>"), array('action' => 'view', $slideshow['Slideshow']['id']),array('escape' => false,'class'=>'btn')); ?>
