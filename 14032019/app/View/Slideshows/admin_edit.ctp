  ...
  <?php echo "\n".$this->Html->script('plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.min.js'); ?>
   ...
   <div class="container-fluid">
		...
		foreach(Configure::read('Config.languages') as $lang)
								{
		echo "<div class='form-group'>"; 
		echo "<label for='name'".$lang." class='control-label col-sm-2'>name(".$lang."):</label><div class='col-sm-10'>"; 
		echo $this->Form->input('Slideshow.name.'.$lang,array('class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
...
*/
		echo "<div class='form-group'>"; 
		echo "<label for='photo' class='control-label col-sm-2'>photo 1920/550: </label><div class='col-sm-10'>"; 
		?>
        
        <div class="fileinput fileinput-new" data-provides="fileinput">
												<div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                
                                                <?php echo "<img src=".$this->webroot.'files/slideshow/'.$this->request->data['Slideshow']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
...
echo "<div class='form-group'>"; 
		...
		echo $this->Form->input('lien',array('id'=>'lien','type'=>'texte','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
