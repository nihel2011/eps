  ...
  <?php echo "\n".$this->Html->script('plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.min.js'); ?>
   <?php echo "\n".$this->Html->script('plugins/fileupload/bootstrap-fileupload.min.js'); ?>
    ...
    <div class="container-fluid">
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Images Contenus</h3>
							</div>
							<div class="box-content nopadding">
                            <?php echo $this->Form->create('ImageContenus',array('type'=>'file','role'=>'form','class'=>'form-horizontal form-column form-bordered')); ?>
                            		<div class="row">
										<div class="col-sm-6">
                            	<?php
		echo "<div class='form-group'>"; 
		echo "<label for='namep' class='control-label col-sm-2'>Titre:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('namep',array('id'=>'namep','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		...
		echo $this->Form->input('contenu_id',array('type'=>'hidden','value'=>"$contenu_id",'id'=>'contenu_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
...
$defaults = array("Y"=>"Yes","N"=>"No");
		echo "<div class='form-group'>"; 
		echo "<label for='defau' class='control-label col-sm-2'>defaut:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('defau',array('options'=>$defaults,'empty'=>'-- Choisir  --','id'=>'defau','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
