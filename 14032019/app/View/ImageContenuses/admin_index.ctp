...
<div class="box-title">
	...
	<div class="col-sm-6">	<h3>Contenus</h3></div>	<div class=" col-sm-6 addplus"  >
		<a href="<?php echo $this->webroot;?>admin/ImageContenuses/add/<?php echo $contenu_id;?>">
			<i class="fa fa-plus-circle" style="font-size:30px; color:#fff"></i>
		</a>
	</div>
</div>
<div class="box-content nopadding">
<table class="table table-hover table-nomargin table-bordered dataTable dataTable-column_filter" data-column_filter_types="null,select,select,text,null,daterange,null,null" data-column_filter_dateformat="dd-mm-yy"  data-nosort="0" data-checkall="all">
<thead>
<tr>
...
<tbody>
	...
	<tr>
        ...
        <td> 
        <?php  $phota = $this->webroot.'files/contenus/'.h($imageContenus['ImageContenus']['photo']) ;
		$photb = 'files/contenus/'.h($imageContenus['ImageContenus']['photo']) ;
		...
		<td class='hidden-480'>
			...
			<?php echo "&nbsp;".$this->Form->postLink(__("<i class='fa fa-times'></i>"), array('action' => 'delete', $imageContenus['ImageContenus']['id'],$contenu_id), array('class'=>'btn','escape' => false,null), __('Etes-vous sûr que vous voulez supprimer # %s?', $imageContenus['ImageContenus']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
