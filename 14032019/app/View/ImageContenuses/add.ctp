<div class="container-fluid">
		...
		echo $this->Form->input('namep',array('id'=>'namep','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
		...
		echo $this->Form->input('contenu_id',array('id'=>'contenu_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
