  ...
  <?php echo "\n".$this->Html->script('plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.min.js'); ?>
   ...
   <div class="container-fluid">
        ...
        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/contenus/'.$this->request->data['ImageContenus']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
		...
		echo $this->Form->input('contenu_id',array('type'=>'hidden','id'=>'contenu_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
