                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Images produits</h3>
							</div>
...
echo $this->Form->input('produit_id',array('type'=>'hidden','id'=>'produit_id','value'=>"$produit_id",'class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		/*echo "<div class='form-group'>"; 
