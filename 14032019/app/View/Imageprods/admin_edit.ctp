   ...
   <div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot; ?>admin/Imageprods/" >Images produits</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a ></a>
...
$etats = array("Y"=>"Actif","N"=>"Inactif");
		...
		$defalts = array("Y"=>"Yes","N"=>"No");
		echo "<div class='form-group'>"; 
		echo "<label for='defau' class='control-label col-sm-2'>defau:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('defau',array('options'=>$defalts,'id'=>'defau','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
 
		echo $this->Form->input('produit_id',array('type'=>'hidden','id'=>'produit_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		...
		echo "<label for='photo' class='control-label col-sm-2'>photo:</label><div class='col-sm-10'>"; 
		 ...
		 <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/produits/'.$this->request->data['Imageprod']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
