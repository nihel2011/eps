<div class="container-fluid">
		...
		echo $this->Form->input('Tarif.name.'.$lang,array('id'=>'name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
	...
	$poplars = array("Y"=>"oui","N"=>"non");
	 ...
	 echo $this->Form->input('service_id',array('type'=>'hidden','id'=>'service_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
