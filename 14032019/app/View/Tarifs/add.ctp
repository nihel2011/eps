<div class="container-fluid">
		...
		echo "<div class='form-group'>"; 
		echo "<label for='service_id' class='control-label col-sm-2'>service_id:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('service_id',array('id'=>'service_id','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
