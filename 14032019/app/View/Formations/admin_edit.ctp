...
<div class="container-fluid">
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('datef',array('class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
	...
	echo "<div class='form-group'>"; 
		...
		<div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/formation/'.$this->request->data['Formation']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
