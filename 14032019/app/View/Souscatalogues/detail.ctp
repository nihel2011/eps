					...
					<div class="col-md-9 col-sm12">
						<div class="single-details mb-30">
							<div class="details-img">
								<img src="<?php echo $this->webroot; ?>files/souscatalogue/<?php echo $souscatalogue['Souscatalogue']['photo'];?>" alt="" />
							</div>
							<div class="event-info">
								<h3><?php echo $souscatalogue['Souscatalogue']['titre'][$lang];?></h3><br>
							</div>
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div class="organizer">
											...
											<!--<h4>Description</h4>-->
											<p><?php echo $souscatalogue['Souscatalogue']['description'][$lang];?></p>
											<h4>Date:  </h4>
											<p><?php echo $souscatalogue['Souscatalogue']['datec'];?></p>
										</div>
									</div>
									<div class="col-md-6">
										<div class="organizer">
