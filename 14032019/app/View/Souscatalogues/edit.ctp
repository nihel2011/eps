<div class="container-fluid">
		...
		echo "<div class='form-group'>"; 
		echo "<label for='description' class='control-label col-sm-2'>description:</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('description',array('id'=>'description','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
