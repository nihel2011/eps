...
<div class="col-sm-6">	<h3>Souscatalogues</h3></div>	<div class=" col-sm-6 addplus"  >
		<a href="admin/Souscatalogue/add">
...
<tbody>
	...
	<tr>
		...
		<td><?php echo h($souscatalogue['Souscatalogue']['name']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['photo']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['etat']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['resume']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['description']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['titre']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['datec']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['created']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['usercreated']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['modify']); ?>&nbsp;</td>
		<td><?php echo h($souscatalogue['Souscatalogue']['usermodify']); ?>&nbsp;</td>
		<td class='hidden-480'>
			<?php echo "&nbsp;".$this->Html->link(__("<i class='fa fa-search'></i>"), array('action' => 'view', $souscatalogue['Souscatalogue']['id']),array('escape' => false,'class'=>'btn')); ?>
