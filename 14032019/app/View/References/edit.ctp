<div class="container-fluid">
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>references</h3>
							</div>
							<div class="box-content nopadding">
                            <?php echo $this->Form->create('Reference',array('type'=>'file','role'=>'form','class'=>'form-horizontal form-column form-bordered')); ?>
                            		<div class="row">
										<div class="col-sm-6">
                            	<?php
		...
		echo "<div class='form-group'>"; 
		echo "<label for='id_secteur' class='control-label col-sm-2'>id_secteur:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('id_secteur',array('id'=>'id_secteur','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
