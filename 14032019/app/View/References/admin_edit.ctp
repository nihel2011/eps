 <?php echo "\n".$this->Html->script('plugins/plupload/plupload.full.min.js'); ?>
  <?php echo "\n".$this->Html->script('plugins/plupload/jquery.plupload.queue/jquery.plupload.queue.min.js'); ?>
   ...
   <div class="container-fluid">
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>Références</h3>
							</div>
		...
		echo $this->Form->input('Reference.name.'.$lang,array('class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		 }
...
$etats = array("Y"=>"Actif","N"=>"Inactif");
		...
		echo "<label for='photo' class='control-label col-sm-2'>photo:</label><div class='col-sm-10'>"; ?>
		  <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/references/'.$this->request->data['Reference']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
