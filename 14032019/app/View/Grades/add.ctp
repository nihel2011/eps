<div class="container-fluid">
		...
		echo "<div class='form-group'>"; 
		echo "<label for='usermodifiy' class='control-label col-sm-2'>usermodifiy:</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('usermodifiy',array('id'=>'usermodifiy','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
