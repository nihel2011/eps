...
<h2><?php echo __('Catalogue'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($catalogue['Catalogue']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Usercreated'); ?></dt>
		<dd>
			<?php echo h($catalogue['Catalogue']['usercreated']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modify'); ?></dt>
		<dd>
			<?php echo h($catalogue['Catalogue']['modify']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Usermodify'); ?></dt>
		<dd>
			<?php echo h($catalogue['Catalogue']['usermodify']); ?>
			&nbsp;
		</dd>
