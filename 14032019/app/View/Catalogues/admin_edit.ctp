...
<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot;?>admin/catalogues/" >Catalogues</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a ></a>
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>catalogues</h3>
							</div>
							<div class="box-content nopadding">
                            <?php echo $this->Form->create('Catalogue',array('type'=>'file','role'=>'form','class'=>'form-horizontal form-column form-bordered')); ?>
                            		<div class="row">
										<div class="col-sm-12">
                            	<?php
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('Catalogue.name.'.$lang,array('id'=>'name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		 } 
		...
		<div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/catalogue/'.$this->request->data['Catalogue']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('datec',array('class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		...
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('Catalogue.resume.'.$lang,array('type'=>'textarea','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='description' class='control-label col-sm-2'>description(".$lang."):</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('Catalogue.description.'.$lang,array('type'=>'textarea','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 

		echo "<div class='form-group'>"; 
		echo "<label for='titre' class='control-label col-sm-2'>titre(".$lang."):</label>"; 
		echo " <div class='col-sm-10'>"; 
		echo $this->Form->input('Catalogue.titre.'.$lang,array('type'=>'textarea','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		 }
