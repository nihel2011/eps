   ...
   <div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li>
							<a href="<?php echo $this->webroot; ?>admin/statistiques"  >Statistiques</a>
							<i class="fa fa-angle-right"></i>
						</li>
						<li>
							<a ></a>
                 ...
                 <div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title">
								<h3>
									<i class="fa fa-list"></i>statistiques</h3>
							</div>
							<div class="box-content nopadding">
                            <?php echo $this->Form->create('Statistique',array('type'=>'file','role'=>'form','class'=>'form-horizontal form-column form-bordered')); ?>
                            		<div class="row">
										<div class="col-sm-12">
                            	<?php
		...
		echo $this->Form->input('Statistique.name.'.$lang,array('id'=>'name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
		 }

		echo "<div class='form-group'>"; 
		echo "<label for='valeurs' class='control-label col-sm-2'>valeurs:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('valeurs',array('id'=>'valeurs','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );
		echo "</div></div>"; 
        ...
        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <?php echo "<img src=".$this->webroot.'files/statistique/'.$this->request->data['Statistique']['photo']." style='width:90%'>"; ?>
                                                </div>
												<div>
