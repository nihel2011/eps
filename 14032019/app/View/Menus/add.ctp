<div class="container-fluid">
		...
		echo "<div class='form-group'>"; 
		echo "<label for='ar_name' class='control-label col-sm-2'>ar_name:</label><div class='col-sm-10'>"; 
		echo $this->Form->input('ar_name',array('id'=>'ar_name','class'=>'form-control','label'=>false,'div'=>false,'autocomplete'=>'off') );</div>
		echo "</div>"; 
